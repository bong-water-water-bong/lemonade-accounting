...
- [architecture.md](architecture.md) — Pipeline and ingestion architecture
- [conventions.md](conventions.md) — Standards and style guides
- [runbook.md](runbook.md) — Execution and validation runbook
